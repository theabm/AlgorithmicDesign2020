...
def get_matrix_quadrants(A: Matrix) -> Tuple[Matrix,Matrix, Matrix, Matrix]:
    ...
    A12 = A.submatrix(0, A.num_of_rows//2, A.num_of_cols//2,A.num_of_cols//2+A.num_of_cols%2)
    A21 = A.submatrix(A.num_of_rows//2, A.num_of_rows//2+A.num_of_rows%2,0,A.num_of_cols//2)
    A22 = A.submatrix(A.num_of_rows//2, A.num_of_rows//2+A.num_of_rows%2,
                      A.num_of_cols//2, A.num_of_cols//2+A.num_of_cols%2)
